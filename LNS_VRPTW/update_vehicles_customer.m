...
function [ vehicles_customer ] = update_vehicles_customer( vehicles_customer,in_index,put_index,in_pos )
...
vehicles_customer{in_index}=put_in;
vehicles_customer{put_index}=[];
end
